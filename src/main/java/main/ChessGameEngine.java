...
public class ChessGameEngine implements Serializable {
  ...
  private boolean selectedPieceIsValid() {
    if (currentPiece == null)
      return false; // user tried to select an empty square
    // choose color to compare according to player
    int compareColor = currentPlayer == 2 ? ChessGamePiece.BLACK : ChessGamePiece.WHITE;
    return currentPiece.getColorOfPiece() == compareColor;
  }
