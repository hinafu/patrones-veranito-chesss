...
public class Pawn
    ...
    protected ArrayList<String> calculatePossibleMoves(ChessGameBoard board) {
        ...
        int enemyCol1 = pieceColumn - 1;
        int enemyCol2 = pieceColumn + 1;
        if (isEnemy(board, enemyRow, enemyCol1)) {
            moves.add(enemyRow + "," + enemyCol1);
        }
        if (isEnemy(board, enemyRow, enemyCol2)) {
            moves.add(enemyRow + "," + enemyCol2);
        }
