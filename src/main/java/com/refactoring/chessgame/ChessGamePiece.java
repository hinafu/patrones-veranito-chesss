 ...
 * Classes to extend this piece are com.refactoring.chessgame.Rook, com.refactoring.chessgame.Bishop, com.refactoring.chessgame.Knight, com.refactoring.chessgame.Queen, com.refactoring.chessgame.King and com.refactoring.chessgame.Pawn.
...
public abstract class ChessGamePiece{
     ...
     * player's com.refactoring.chessgame.King to be put in check (which is an illegal move).
     *
     * @param board
     ...
     * in GamePiece and not com.refactoring.chessgame.ChessGameBoard because different pieces have
